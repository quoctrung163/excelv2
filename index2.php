<?php
if (isset($_POST["txtHoTen"]) || isset($_POST["txtNgaySinh"]) || isset($_POST["txtSoHieuVanBang"]) || isset($_POST["txtMaSoSinhVien"]) || isset($_POST["txtNamTotNghiep"])) {
    ...
    $result = searchByParams($_POST["txtHoTen"], $_POST["txtNgaySinh"], $_POST["txtSoHieuVanBang"], $_POST["txtMaSoSinhVien"], $_POST["txtNamTotNghiep"], $data);
...
<div class="row justify-content-center align-item-center" style="margin-top: 100px;">
    ...
    align-items: center;" action="<?php $_PHP_SELF ?>" method="POST">
